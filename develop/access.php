...
<main>
  ...
  <header class="main-visual clearfix">
   ...
   <div class="image"><img src="./images/access/mv.jpg" alt="" class="pc"><img src="./images/access/mv-sp.jpg" alt="" class="sp"><p class="annotation white">航空写真</p></div>
  </header><!-- main-visual -->
  ...
  <section class="sections airport clearfix">
    ...
    <div class="wrap">
      ...
      <ul class="column02 bottom">
        ...
        <li>
          <div class="txt">
          <img src="./images/access/air02-txt.svg" alt="">
          </div>
        </li>
      </ul>
      <ul class="column02">
        ...
        <li>
          <div class="txt">
          <img src="./images/access/air03-txt.svg" alt="">
          </div>
        </li>
      </ul>
      <div class="check">
        <ul class="column02">
          <li>
            <div class="txt">
            <img src="./images/access/air04-txt.svg" alt="">
            </div>
          </li>
          <li>
            <div class="image">
  ...
  <section class="sections car clearfix">
    ...
    <div class="wrap">
      ...
      <p class="tit01">首都高速1号羽田線<br class="sp"><span>「羽田」</span>入口から</p>
      <ul class="column03">
        <li>
          <div class="image">
