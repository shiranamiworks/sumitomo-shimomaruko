...
<main>
  ...
  <section class="intro sections clearfix">
    <div class="inner">
      <p class="tit"><img src="./images/design/title01.svg"></p>
      ...
      <p class="lead">白とグレーを基調としたモノトーンの外観に、ガラス手摺がシャープな輝きを放つ洗練された意匠。<br class="pc">ひときわ際立つシンボリックなファサードが、新たな風景を刻みます。</p>
    </div>
  </section><!-- intro -->
  ...
  <div class="sections landscape clearfix">
    <p class="tit"><span><img src="./images/design/title02.svg"></span></p>
    <div class="inner">
      <p class="txt">緑の潤いと開放感に満ちたランドスケープ</p>
      <p class="lead">総敷地面積８,200㎡超の広大な敷地に、各棟の見合いを避けるように住棟をゆったりとレイアウト。<br class="pc">プライバシー性や採光・通風などの居住性に配慮しています。</p>
