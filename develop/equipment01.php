...
<main>
  ...
  <section class="sections sec02 clearfix">
    <div class="wrap">
      ...
      <ul class="lists list01 clearfix">
        <li>
          <p class="tit-img pt22">プッシュ式水栓</p>
          <div class="image pc">
      ...
      <ul class="lists list04 clearfix">
        <li>
          ...
          <p class="lead">コンパクトなフォルムを実現したローシルエットタンクトイレを採用。温水シャワーが快適に使え、着座センサーによりノンタッチで便器の自動洗浄も行なう先進の機能付きです。また、洗浄使用水量が少ない節水タイプで、経済面・環境面に優しい仕様です。</p>
        </li>
        <li>
