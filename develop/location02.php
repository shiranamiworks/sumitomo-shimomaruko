...
<main>
  ...
  <section class="sections areas area02 clearfix">
    ...
    <div class="inner">
      ...
      <p class="txt02 bottom">「矢口の渡し」と呼ばれる多摩川の旧跡を再現した公園。小舟に乗ったり、暑い季節には水遊びをする子どもの姿が見られます。広い園内には四季折々の花が咲く花壇のほか、砂場や遊具のエリア、フットサルコートやバスケットコート、テニスコートがあり、幅広い年代の憩いの場所となっています。</p>
      <ul class="column02">
        <li>
          <div class="image">
